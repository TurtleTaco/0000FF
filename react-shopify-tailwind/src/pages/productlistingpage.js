  ...
  render() {
    ...
    return (
      <div className="absolute w-full">
        ...
        >
          <div
            className={`${this.navigationWidthSmallScreen} md:${this.navigationWidthMediunScreen} inline-block pl-6 text-left text-xs FrontPageShopButtonFont my-2`}
          >
            All
            <ArrowRightIcon />
          </div>
          ...
          >
            <div
              className={`text-center text-xs FrontPageShopButtonFont my-2`}
              style={{
            ...
            <div
              className={`hidden relative md:block md:w-full ${this.filterDropdownWidthMediunScreen}`}
              onMouseLeave={this.HandleFilterHoverEventChange}
            >
              <div
                className={"absolute z-10 w-full ".concat(
                  this.state.filterDropdownOpened
          ...
          >
            ...
            <div
              className={`hidden relative md:block md:w-full ${this.sortDropdownWidthMediunScreen}`}
        ...
        <div className="mx-1">{products}</div>
      </div>
    );
  }
}
