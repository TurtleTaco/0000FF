  ...
  render() {
    ...
    return (
        <div className="relative">
            ...
            style = {{fontSize : `40px`}}/>
            <ChevronRightIcon className="absolute arrowgroup z-10 right-0" onClick = {this.HandleRightArrowClick} 
            style = {{fontSize : `40px`}}/>
            

            <div className="relative">
                <img className="fade" key={this.images[this.state.index]} src={this.images[this.state.index]}/>
